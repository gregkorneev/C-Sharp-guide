...
У тебя сейчас раздел 4 “Разметка диска и монтирование разделов” не получается, потому что в системе нет /mnt/disk1 и /mnt/disk2.

На твоём скрине видно:

ls /mnt

выводит пусто, а команды:

ls /mnt/disk1
ls /mnt/disk2

дают ошибку, потому что таких каталогов нет.

⸻

Вариант 1 — если нужно просто сделать как в отчёте
...
Потом создай точки монтирования:
